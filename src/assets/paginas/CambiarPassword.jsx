...
const CambiarPassword = () => {
  ...
  return (
    <>
        ...
        <h2 className="font-black text-center text-2xl mt-10">Cambiar Password</h2>
        <p className="text-xl mt-5 text-center mb-10">Modifica tu{''} <span className="text-indigo-600 font-bold">Password aqui</span></p>
